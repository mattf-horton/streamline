...
echo "Adding identity and Stellar UDFs"
curl -i --negotiate -u:anyUser  -b /tmp/cookiejar.txt -c /tmp/cookiejar.txt -s -X POST "${CATALOG_ROOT_URL}/streams/udfs" -F udfConfig='{"name":"IDENTITY", "displayName": "Identity", "description": "Identity function", "type":"FUNCTION", "className":"com.hortonworks.streamline.streams.udf.Identity", "builtin":true};type=application/json' -F udfJarFile=@${jarFile}
curl -i --negotiate -u:anyUser  -b /tmp/cookiejar.txt -c /tmp/cookiejar.txt -s -X POST "${CATALOG_ROOT_URL}/streams/udfs" -F udfConfig='{"name":"STELLAR_STRING_EXPRESSION", "displayName": "StellarStringExpression", "description": "Stellar function of one input producing a string output", "type":"FUNCTION", "argTypes":["BOOLEAN|BYTE|SHORT|INTEGER|LONG|FLOAT|DOUBLE|STRING"], "returnType": "STRING", "className":"com.hortonworks.streamline.streams.udf.stellar.StellarUDFs.StellarStringExpression", "builtin":true};type=application/json' -F udfJarFile=@${jarFile}
curl -i --negotiate -u:anyUser  -b /tmp/cookiejar.txt -c /tmp/cookiejar.txt -s -X POST "${CATALOG_ROOT_URL}/streams/udfs" -F udfConfig='{"name":"STELLAR_INTEGER_EXPRESSION", "displayName": "StellarIntegerExpression", "description": "Stellar function of one input producing a Long Integer output", "type":"FUNCTION", "argTypes":["BOOLEAN|BYTE|SHORT|INTEGER|LONG|FLOAT|DOUBLE|STRING"], "returnType": "LONG", "className":"com.hortonworks.streamline.streams.udf.stellar.StellarUDFs.StellarIntegerExpression", "builtin":true};type=application/json' -F udfJarFile=@${jarFile}
curl -i --negotiate -u:anyUser  -b /tmp/cookiejar.txt -c /tmp/cookiejar.txt -s -X POST "${CATALOG_ROOT_URL}/streams/udfs" -F udfConfig='{"name":"STELLAR_FLOAT_EXPRESSION", "displayName": "StellarFloatExpression", "description": "Stellar function of one input producing a Double Float output", "type":"FUNCTION", "argTypes":["BOOLEAN|BYTE|SHORT|INTEGER|LONG|FLOAT|DOUBLE|STRING"], "returnType": "FLOAT", "className":"com.hortonworks.streamline.streams.udf.stellar.StellarUDFs.StellarFloatExpression", "builtin":true};type=application/json' -F udfJarFile=@${jarFile}
curl -i --negotiate -u:anyUser  -b /tmp/cookiejar.txt -c /tmp/cookiejar.txt -s -X POST "${CATALOG_ROOT_URL}/streams/udfs" -F udfConfig='{"name":"STELLAR_PREDICATE", "displayName": "StellarPredicate", "description": "Stellar predicate with one input", "type":"FUNCTION", "argTypes":["BOOLEAN|BYTE|SHORT|INTEGER|LONG|FLOAT|DOUBLE|STRING"], "returnType": "BOOLEAN", "className":"com.hortonworks.streamline.streams.udf.stellar.StellarUDFs.StellarPredicate", "builtin":true};type=application/json' -F udfJarFile=@${jarFile}
curl -i --negotiate -u:anyUser  -b /tmp/cookiejar.txt -c /tmp/cookiejar.txt -s -X POST "${CATALOG_ROOT_URL}/streams/udfs" -F udfConfig='{"name":"STELLAR_STRING_EXPRESSION2", "displayName": "StellarStringExpression2", "description": "Stellar function of two inputs producing a string output", "type":"FUNCTION", "argTypes":["BOOLEAN|BYTE|SHORT|INTEGER|LONG|FLOAT|DOUBLE|STRING"], "returnType": "STRING", "className":"com.hortonworks.streamline.streams.udf.stellar.StellarUDFs.StellarStringExpression2", "builtin":true};type=application/json' -F udfJarFile=@${jarFile}
curl -i --negotiate -u:anyUser  -b /tmp/cookiejar.txt -c /tmp/cookiejar.txt -s -X POST "${CATALOG_ROOT_URL}/streams/udfs" -F udfConfig='{"name":"STELLAR_INTEGER_EXPRESSION2", "displayName": "StellarIntegerExpression2", "description": "Stellar function of two inputs producing a Long Integer output", "type":"FUNCTION", "argTypes":["BOOLEAN|BYTE|SHORT|INTEGER|LONG|FLOAT|DOUBLE|STRING"], "returnType": "LONG", "className":"com.hortonworks.streamline.streams.udf.stellar.StellarUDFs.StellarIntegerExpression2", "builtin":true};type=application/json' -F udfJarFile=@${jarFile}
curl -i --negotiate -u:anyUser  -b /tmp/cookiejar.txt -c /tmp/cookiejar.txt -s -X POST "${CATALOG_ROOT_URL}/streams/udfs" -F udfConfig='{"name":"STELLAR_FLOAT_EXPRESSION2", "displayName": "StellarFloatExpression2", "description": "Stellar function of two inputs producing a Double Float output", "type":"FUNCTION", "argTypes":["BOOLEAN|BYTE|SHORT|INTEGER|LONG|FLOAT|DOUBLE|STRING"], "returnType": "FLOAT", "className":"com.hortonworks.streamline.streams.udf.stellar.StellarUDFs.StellarFloatExpression2", "builtin":true};type=application/json' -F udfJarFile=@${jarFile}
curl -i --negotiate -u:anyUser  -b /tmp/cookiejar.txt -c /tmp/cookiejar.txt -s -X POST "${CATALOG_ROOT_URL}/streams/udfs" -F udfConfig='{"name":"STELLAR_PREDICATE2", "displayName": "StellarPredicate2", "description": "Stellar predicate with two inputs", "type":"FUNCTION", "argTypes":["BOOLEAN|BYTE|SHORT|INTEGER|LONG|FLOAT|DOUBLE|STRING"], "returnType": "BOOLEAN", "className":"com.hortonworks.streamline.streams.udf.stellar.StellarUDFs.StellarPredicate2", "builtin":true};type=application/json' -F udfJarFile=@${jarFile}
